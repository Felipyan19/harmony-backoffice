...
export const initialConversationLabels: ConversationLabel[] = [
  { id: 'lbl_reserva', name: 'Reserva', color: 'green' },
  { id: 'lbl_romantico', name: 'Plan romántico', color: 'rose' },
  { id: 'lbl_prioridad', name: 'Prioridad', color: 'gold' },
  { id: 'lbl_disponibilidad', name: 'Disponibilidad', color: 'blue' },
  { id: 'lbl_recurrente', name: 'Cliente recurrente', color: 'violet' },
];

const label = (id: string) => initialConversationLabels.find((item) => item.id === id)!;
...
export const initialConversations: Conversation[] = [
  {
    ...
    labels: [label('lbl_romantico'), label('lbl_prioridad'), label('lbl_disponibilidad')],
    messages: [
  ...
  },
  {
    ...
    labels: [label('lbl_recurrente'), label('lbl_romantico')],
    messages: [
  ...
  },
  {
    ...
    labels: [label('lbl_disponibilidad')],
    messages: [
